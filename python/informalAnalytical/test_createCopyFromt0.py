...
must leave db/T/tFirst/x0/db['t0'] self-consistent for a genuinely shorter, renumbered horizon.

Run:  .venv\Scripts\python.exe python\informalAnalytical\test_createCopyFromt0.py
"""
import os, sys
import numpy as np
import pandas as pd
...
# ---- 4. LOG.solveRobust actually runs on the copy (warm-start caches genuinely cleared, not stale-shaped)
