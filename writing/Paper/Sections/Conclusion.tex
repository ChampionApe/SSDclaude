...
Calibrating the model to Argentina, it accounts for about a third of the observed increase in pension spending due to a reform that made pensions universal, and for more over time as the newly covered households retire with less private savings. The model predicts a decrease in private savings of 0.2 p.p.\ of GDP and a decrease in labor supply of about 0.3\%, in line with observed evidence. Taxation is the main factor behind the reduction in private savings and labor supply. 
