...
# Income and hours relative to the average FORMAL household, eq (calibration:z) -- see InformalSavings/test.py.
...
# The workbook's 'Savings rate' is what it superseded -- notes/argentina_calibrationTarget.md.
