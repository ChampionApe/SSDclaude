...
To capture the relative income and working hours of the informal households, requires a bit more. First, the ratio of income and working hours can still be written as:
\begin{align*}
    z_0^{\eta} &= \frac{w_t^0h_{t,0}\eta_{0}}{w_t(1-\tau_t)h_t} \\
    z_0^x &= \dfrac{h_{t,0}}{\sum_i \gamma_{i} h_{t,i}}
\end{align*}
