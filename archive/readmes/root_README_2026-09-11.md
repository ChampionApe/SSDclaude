...
| `TODO.md` | the one open list (consolidated 2026-09-11): next build, paper text, final-version items, the permanent-timing reruns, module loose ends, traps. Closed work is in the logs, not here |
| `paper_styleGuide.md` | voice, paragraph anatomy, units and LaTeX conventions of the paper draft, for the rewrite sessions |
| `archive/` | measurements and results demoted out of the module READMEs, and the closed to-do files (`todo_paperRewrite.md`, the 2026-09-08 rewrite plan; `todo_escPermanentTiming.md`) |
...
be edited through Excel, not openpyxl — `notes/TODO.md`, "Traps to remember".
