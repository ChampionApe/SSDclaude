...
# Read in data from excel: C:\Users\sxj477\Documents\GitHub\SSDclaude\data\USMain_test.xlsx
PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'USMain_test.xlsx')
