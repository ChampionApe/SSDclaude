...
Households value consumption and leisure, and discount the future at factor $\beta \in(0,1)$. Representing utility by function $u(c,h)$ with $u'_c\geq 0, u'_h\leq 0, u''_{cc}\leq 0, u''_{hh}\geq0$, the welfare of a young household of type $i$ born in period $t$ is defined by
\begin{align}
